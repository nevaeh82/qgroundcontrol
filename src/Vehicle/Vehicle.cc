...
const char* Vehicle::_headingToHomeFactName =       QT_TR_NOOP("headingToHome");
const char* Vehicle::_distanceToGCSFactName =       QT_TR_NOOP("distanceToGCS");
...
const char* Vehicle::_estimatorStatusFactGroupName =    QT_TR_NOOP("estimatorStatus");
